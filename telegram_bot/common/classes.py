...
class FSMActions:
    ...
    GET_USER_ANNOUNCEMENTS: str = "/get_user_announcements/request"
    COLLECTED_USER_ANNOUNCEMENTS: str = "/get_user_announcements/response"
    GET_ANNOUNCEMENTS: str = "/get_announcements/request"
    COLLECTED_ANNOUNCEMENTS: str = "/get_announcements/response"
